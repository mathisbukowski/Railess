    ...
    return (
        <div>
            ...
            <div className="w-full py-[5rem] px-4 bg-white">
                ...
                <p style={{ color: 'black'}} className=" text-1xl text-lineColor font-bold font-kode max-w-[1240px] mx-auto grid lg:grid-cols-1">    - /api/getAllCrossedStationsByTrip/:tripId</p>
