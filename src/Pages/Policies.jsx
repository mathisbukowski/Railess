    ...
    return (
        <div>
            ...
            <div className="w-full py-[5rem] px-4 bg-white">
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">General Policy</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Collection and Use of Information</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Cookies</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Information sharing</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Security</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Changes to the Privacy Policy</p>
                ...
                <p style={{ fontWeight: 'bold', color: 'black'}} className=" text-2xl font-bold text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-3">Contact us</p>
                <p style={{ color: 'black'}} className=" text-1xl text-lineColor font-kode max-w-[1240px] mx-auto grid lg:grid-cols-1">If you have any questions about this Privacy Policy, you can contact us at Rainless59000@gmail.com.</p>
            </div>
            <Newsletter />
            <Footer />
        </div>
